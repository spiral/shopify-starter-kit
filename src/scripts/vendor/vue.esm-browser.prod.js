  ...
  if (
    (it(e)
      ...
      : (c = N(e)
          ? () =>
              e.map((e) =>
                it(e) ? e.value : et(e) ? Gn(e) : $(e) ? wt(e, l, 2) : void 0
              )
          : $(e)
          ? t
            ? () => wt(e, l, 2)
...
function ao(e, t, n = Rr) {
  ...
  if (($n(t, o, n), n)) {
    let e = n.parent;
    for (; e && e.parent; )
      oo(e.parent.vnode) && uo(o, t, n, e), (e = e.parent);
  }
}
function uo(e, t, n, o) {
  const r = $n(t, e, o, !0);
...
function pc(e, t, { helper: n, push: o, newline: r }) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e[n];
    o(`const ${Tl(i, t)} = ${s}(${JSON.stringify(i)})`),
      n < e.length - 1 && r();
  }
}
function fc(e, t) {
